...
// Utility, country 1
Util1 = 1/exp(c1muc)*log(exp(c1muc)*exp(c1c)-c1vkappa/c1grmuzss*exp(c1c(-1)))+c1chi0/(1-c1chi)*(1-exp(c1l))^(1-c1chi);

// Welfare, country 1
//Welf1 = Util1 + nbeta*Welf1(1);

// Utility, country 2
Util2 = 1/exp(c2muc)*log(exp(c2muc)*exp(c2c)-c2vkappa/c2grmuzss*exp(c2c(-1)))+c2chi0/(1-c2chi)*(1-exp(c2l))^(1-c2chi);
