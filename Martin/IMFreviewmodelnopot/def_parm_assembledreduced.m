...
c1delta = 0.025;     % depreciation rate
...
c1phib = 0.0001;          % stationarity-inducing parameter for NFA
...
c1shareiy = 0.15;      %investment share of gross output
c1sharegy = 0.15;      %government spending share of gross output
...
c2delta = 0.025;  % depreciation rate
...
% persistence parameters for shock process
c2rhozi = c1rhozi;
...
c2rhomuoc1 = c1rhomuoc1;
c2rhomuoc2 = c1rhomuoc2;

c2rhomuc = c1rhomuc;
c2rhoomegacm1 = c1rhoomegacm1;
c2rhoomegacm2 = c1rhoomegacm2;

c2psii = c1psii;      % investmetn adjustment costs
c2vkappa = c1vkappa;      % consumption habits
c2scalezierr = c1scalezierr;
...
c1thetap = 0.10;
c1thetaw = 0.10; 
%c1kappaw = (1-c1xiw)*(1-c1beta*c1xiw)/c1xiw/(1+(c1jrtheta-1)*(1+c1thetaw)/c1thetaw);
c1gamdw  = 0;
...
c2rhopitar = c1rhopitar;
c2scalepitarerr = c1scalepitarerr;

c2xiw = c1xiw;
c2thetaw = c1thetaw;
c2rhothetawvar = c1rhothetawvar;
c2scalethetawvarerr = c1scalethetawvarerr;
%c2kappaw = (1-c2xiw)*(1-c2beta*c2xiw)/c2xiw/(1+(c2jrtheta-1)*(1+c2thetaw)/c2thetaw);
