function makechart(titlelist,legendlist,figlabel,ylabels,zdata1,zdata2,zdata3,zdata4)
...
elseif ((nargin>8) | (nargin <=4))
    error ('makechart takes 5 to 8 arguments')
end
...
for i = 1:nvars
    ...
    h1=plot(xvalues,zdata3(:,i),'g:','LineWidth',2); hold on
    h1=plot(xvalues,zdata4(:,i),'k-.','LineWidth',2);
