function [optys,check] = open_economy_completemarkets_ramsey_steadystate(junk,ys)
...
nexog = M_.exo_nbr;
exog = zeros(nexog,1);
[ys] = get_first_guess_completemarkets_ramsey_ss('');
...
optys=fsolve(@(ys) open_economy_completemarkets_ramsey_static(ys,exog,M_.params),ys,options);
