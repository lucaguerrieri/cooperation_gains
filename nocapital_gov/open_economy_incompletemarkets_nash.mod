...
c1lmult21 + 1/(cc - muc)^gamma_p - c1lmult19*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p) + c1lmult20*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p)*(omega_cc_p - 1) + (beta_p*c1lmult1*gamma_p*r_price_cc*(cc - muc)^(gamma_p - 1))/(infl(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c1lmult11*gamma_p*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc*(cc - muc)^(gamma_p + 1)) - (beta_p*c1lmult1(-1)*gamma_p*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl*nbeta*r_price_cc*(cc - muc)^(gamma_p + 1)); 
...
c1lmult7*((infl^2*phi_p)/infl_ss^2 + (2*infl*phi_p*(infl/infl_ss - 1))/infl_ss) - c1lmult6*((infl*phi_p)/infl_ss^2 + (phi_p*(infl/infl_ss - 1))/infl_ss) - (c1lmult5*phi_p*(infl/infl_ss - 1))/infl_ss - (c1lmult25(-1)*r_exchg)/(infl2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) - (beta_p*c1lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl^2*nbeta*r_price_cc*(cc - muc)^gamma_p); 
c1lmult10*((infl2^2*phi2_p)/infl_ss^2 + (2*infl2*phi2_p*(infl2/infl_ss - 1))/infl_ss) - c1lmult9*((infl2*phi2_p)/infl_ss^2 + (phi2_p*(infl2/infl_ss - 1))/infl_ss) - (c1lmult8*phi2_p*(infl2/infl_ss - 1))/infl_ss + (c1lmult25(-1)*infl*r_exchg)/(infl2^2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) + (c1lmult28*gdp(-1)*nfa(-1)*r_exchg)/(gdp*infl2^2*r_exchg(-1)) - (beta_p*c1lmult2(-1)*r_price_cc2(-1)*(cc2(-1) - muc2(-1))^gamma_p)/(infl2^2*nbeta*r_price_cc2*(cc2 - muc2)^gamma_p); 
...
c1lmult1/(rate1 + 1)^2 - (c1lmult3*dphidlp(+1)*gdp(+1)*(tau_p - sigma(+1) + 1))/(rate1 + 1)^2 + (c1lmult25*infl(+1)*r_exchg(+1))/(infl2(+1)*r_exchg*(rate1 + 1)^2); 
c1lmult27 + c1lmult28*(cc_m/gdp - (gdp(-1)*nfa(-1))/(gdp*infl2*r_exchg(-1))) + (c1lmult25*infl(+1)*r_exchg(+1))/(infl2(+1)*r_exchg^2*(rate1 + 1)) - (c1lmult25(-1)*infl)/(infl2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) - (c1lmult20*cc*r_price_cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg^2*rho_cc_p) + (c1lmult28(+1)*gdp*nbeta*nfa*r_exchg(+1))/(gdp(+1)*infl2(+1)*r_exchg^2); 
...
(beta_p*c1lmult1*(cc - muc)^gamma_p)/(infl(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c1lmult19*cc*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p + (c1lmult20*cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg*rho_cc_p) - (beta_p*c1lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl*nbeta*r_price_cc^2*(cc - muc)^gamma_p) - (c1lmult11*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc^2*(cc - muc)^gamma_p); 
...
c2lmult21 - c2lmult19*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p) + c2lmult20*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p)*(omega_cc_p - 1) + (beta_p*c2lmult1*gamma_p*r_price_cc*(cc - muc)^(gamma_p - 1))/(infl(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c2lmult11*gamma_p*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc*(cc - muc)^(gamma_p + 1)) - (beta_p*c2lmult1(-1)*gamma_p*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl*nbeta*r_price_cc*(cc - muc)^(gamma_p + 1)); 
...
c2lmult7*((infl^2*phi_p)/infl_ss^2 + (2*infl*phi_p*(infl/infl_ss - 1))/infl_ss) - c2lmult6*((infl*phi_p)/infl_ss^2 + (phi_p*(infl/infl_ss - 1))/infl_ss) - (c2lmult5*phi_p*(infl/infl_ss - 1))/infl_ss - (c2lmult25(-1)*r_exchg)/(infl2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) - (beta_p*c2lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl^2*nbeta*r_price_cc*(cc - muc)^gamma_p); 
c2lmult10*((infl2^2*phi2_p)/infl_ss^2 + (2*infl2*phi2_p*(infl2/infl_ss - 1))/infl_ss) - c2lmult9*((infl2*phi2_p)/infl_ss^2 + (phi2_p*(infl2/infl_ss - 1))/infl_ss) - (c2lmult8*phi2_p*(infl2/infl_ss - 1))/infl_ss + (c2lmult25(-1)*infl*r_exchg)/(infl2^2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) + (c2lmult28*gdp(-1)*nfa(-1)*r_exchg)/(gdp*infl2^2*r_exchg(-1)) - (beta_p*c2lmult2(-1)*r_price_cc2(-1)*(cc2(-1) - muc2(-1))^gamma_p)/(infl2^2*nbeta*r_price_cc2*(cc2 - muc2)^gamma_p); 
...
c2lmult27 + c2lmult28*(cc_m/gdp - (gdp(-1)*nfa(-1))/(gdp*infl2*r_exchg(-1))) + (c2lmult25*infl(+1)*r_exchg(+1))/(infl2(+1)*r_exchg^2*(rate1 + 1)) - (c2lmult25(-1)*infl)/(infl2*nbeta*r_exchg(-1)*(rate1(-1) + 1)) - (c2lmult20*cc*r_price_cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg^2*rho_cc_p) + (c2lmult28(+1)*gdp*nbeta*nfa*r_exchg(+1))/(gdp(+1)*infl2(+1)*r_exchg^2); 
...
(beta_p*c2lmult1*(cc - muc)^gamma_p)/(infl(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c2lmult19*cc*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p + (c2lmult20*cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg*rho_cc_p) - (beta_p*c2lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl*nbeta*r_price_cc^2*(cc - muc)^gamma_p) - (c2lmult11*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc^2*(cc - muc)^gamma_p); 
