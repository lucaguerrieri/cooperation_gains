...
var c1lmult1,  c1lmult2,  c1lmult3,  c1lmult4,  c1lmult5,  c1lmult6,   
    ...
    c1lmult25,  c1lmult26,  c1lmult27,  c1lmult28,  c2lmult1,  c2lmult2,   
    c2lmult3,  c2lmult4,  c2lmult5,  c2lmult6,  c2lmult7,  c2lmult8,   
    c2lmult9,  c2lmult10,  c2lmult11,  c2lmult12,  c2lmult13,  c2lmult14,   
    c2lmult15,  c2lmult16,  c2lmult17,  c2lmult18,  c2lmult19,  c2lmult20,   
    c2lmult21,  c2lmult22,  c2lmult23,  c2lmult24,  c2lmult25,  c2lmult26,   
    c2lmult27,  c2lmult28; 
...
c1lmult20 - c1lmult18 - c1lmult21*cc_m^(1/(rho_cc_p + 1) - 1)*(cc_d^(1/(rho_cc_p + 1))*omega_cc_p^(rho_cc_p/(rho_cc_p + 1)) + cc_m^(1/(rho_cc_p + 1))*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)))^rho_cc_p*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)); 
c1lmult23 - c1lmult17 - c1lmult24*cc_m2^(1/(rho_cc_p + 1) - 1)*(cc_d2^(1/(rho_cc_p + 1))*omega_cc_p^(rho_cc_p/(rho_cc_p + 1)) + cc_m2^(1/(rho_cc_p + 1))*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)))^rho_cc_p*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)); 
...
c1lmult15 + c1lmult17 - c1lmult3*((phi - 1)*((tau_p + 1)/theta_p - (sigma*(theta_p + 1))/theta_p) - dphidp*(tau_p - sigma + 1)) + (c1lmult3(-1)*dphidlp*(tau_p - sigma + 1))/(nbeta*(rate1(-1) + 1)); 
...
c1lmult7*((infl1^2*phi_p)/infl_ss^2 + (2*infl1*phi_p*(infl1/infl_ss - 1))/infl_ss) - c1lmult6*((infl1*phi_p)/infl_ss^2 + (phi_p*(infl1/infl_ss - 1))/infl_ss) - (c1lmult5*phi_p*(infl1/infl_ss - 1))/infl_ss - (beta_p*c1lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl1^2*nbeta*r_price_cc*(cc - muc)^gamma_p); 
c1lmult11 - c1lmult15*exp(theta) - chi0_p*labor^chi_p - c1lmult27*tau_l*wages; 
c1lmult12 - c1lmult16*exp(theta2) - c1lmult28*tau_l2*wages2; 
...
c1lmult1/(rate1 + 1)^2 - (c1lmult3*dphidlp(+1)*gdp(+1)*(tau_p - sigma(+1) + 1))/(rate1 + 1)^2; 
c1lmult2/(rate2 + 1)^2 - (c1lmult4*dphidlp2(+1)*gdp2(+1)*(tau_p - sigma2(+1) + 1))/(rate2 + 1)^2; 
c1lmult25 + (c1lmult26*r_price_cc2)/r_price_cc - (c1lmult20*cc*r_price_cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg^2*rho_cc_p); 
c1lmult25/r_exchg2^2 - (c1lmult23*cc2*r_price_cc2*(r_price_cc2/r_exchg2)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2^2*rho_cc_p); 
(beta_p*c1lmult1*(cc - muc)^gamma_p)/(infl1(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c1lmult19*cc*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p - (c1lmult26*r_exchg*r_price_cc2)/r_price_cc^2 + (c1lmult20*cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg*rho_cc_p) - (beta_p*c1lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl1*nbeta*r_price_cc^2*(cc - muc)^gamma_p) - (c1lmult11*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc^2*(cc - muc)^gamma_p); 
(c1lmult26*r_exchg)/r_price_cc - (c1lmult22*cc2*omega_cc_p*r_price_cc2^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p + (beta_p*c1lmult2*(cc2 - muc2)^gamma_p)/(infl2(+1)*r_price_cc2(+1)*(cc2(+1) - muc2(+1))^gamma_p) + (c1lmult23*cc2*(r_price_cc2/r_exchg2)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2*rho_cc_p) - (beta_p*c1lmult2(-1)*r_price_cc2(-1)*(cc2(-1) - muc2(-1))^gamma_p)/(infl2*nbeta*r_price_cc2^2*(cc2 - muc2)^gamma_p) - (c1lmult12*wages2*(tau_l2 - 1)*(-(wages2*(tau_l2 - 1))/(chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2^2*(cc2 - muc2)^gamma_p); 
...
c2lmult20 - c2lmult18 - c2lmult21*cc_m^(1/(rho_cc_p + 1) - 1)*(cc_d^(1/(rho_cc_p + 1))*omega_cc_p^(rho_cc_p/(rho_cc_p + 1)) + cc_m^(1/(rho_cc_p + 1))*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)))^rho_cc_p*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)); 
c2lmult23 - c2lmult17 - c2lmult24*cc_m2^(1/(rho_cc_p + 1) - 1)*(cc_d2^(1/(rho_cc_p + 1))*omega_cc_p^(rho_cc_p/(rho_cc_p + 1)) + cc_m2^(1/(rho_cc_p + 1))*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)))^rho_cc_p*(1 - omega_cc_p)^(rho_cc_p/(rho_cc_p + 1)); 
...
c2lmult15 + c2lmult17 - c2lmult3*((phi - 1)*((tau_p + 1)/theta_p - (sigma*(theta_p + 1))/theta_p) - dphidp*(tau_p - sigma + 1)) + (c2lmult3(-1)*dphidlp*(tau_p - sigma + 1))/(nbeta*(rate1(-1) + 1)); 
...
c2lmult10*((infl2^2*phi2_p)/infl_ss^2 + (2*infl2*phi2_p*(infl2/infl_ss - 1))/infl_ss) - c2lmult9*((infl2*phi2_p)/infl_ss^2 + (phi2_p*(infl2/infl_ss - 1))/infl_ss) - (c2lmult8*phi2_p*(infl2/infl_ss - 1))/infl_ss - (beta_p*c2lmult2(-1)*r_price_cc2(-1)*(cc2(-1) - muc2(-1))^gamma_p)/(infl2^2*nbeta*r_price_cc2*(cc2 - muc2)^gamma_p); 
c2lmult11 - c2lmult15*exp(theta) - c2lmult27*tau_l*wages; 
c2lmult12 - c2lmult16*exp(theta2) - chi0_p*labor2^chi_p - c2lmult28*tau_l2*wages2; 
...
c2lmult1/(rate1 + 1)^2 - (c2lmult3*dphidlp(+1)*gdp(+1)*(tau_p - sigma(+1) + 1))/(rate1 + 1)^2; 
c2lmult2/(rate2 + 1)^2 - (c2lmult4*dphidlp2(+1)*gdp2(+1)*(tau_p - sigma2(+1) + 1))/(rate2 + 1)^2; 
c2lmult25 + (c2lmult26*r_price_cc2)/r_price_cc - (c2lmult20*cc*r_price_cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg^2*rho_cc_p); 
c2lmult25/r_exchg2^2 - (c2lmult23*cc2*r_price_cc2*(r_price_cc2/r_exchg2)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2^2*rho_cc_p); 
(beta_p*c2lmult1*(cc - muc)^gamma_p)/(infl1(+1)*r_price_cc(+1)*(cc(+1) - muc(+1))^gamma_p) - (c2lmult19*cc*omega_cc_p*r_price_cc^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p - (c2lmult26*r_exchg*r_price_cc2)/r_price_cc^2 + (c2lmult20*cc*(r_price_cc/r_exchg)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg*rho_cc_p) - (beta_p*c2lmult1(-1)*r_price_cc(-1)*(cc(-1) - muc(-1))^gamma_p)/(infl1*nbeta*r_price_cc^2*(cc - muc)^gamma_p) - (c2lmult11*wages*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc^2*(cc - muc)^gamma_p); 
(c2lmult26*r_exchg)/r_price_cc - (c2lmult22*cc2*omega_cc_p*r_price_cc2^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p + (beta_p*c2lmult2*(cc2 - muc2)^gamma_p)/(infl2(+1)*r_price_cc2(+1)*(cc2(+1) - muc2(+1))^gamma_p) + (c2lmult23*cc2*(r_price_cc2/r_exchg2)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2*rho_cc_p) - (beta_p*c2lmult2(-1)*r_price_cc2(-1)*(cc2(-1) - muc2(-1))^gamma_p)/(infl2*nbeta*r_price_cc2^2*(cc2 - muc2)^gamma_p) - (c2lmult12*wages2*(tau_l2 - 1)*(-(wages2*(tau_l2 - 1))/(chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2^2*(cc2 - muc2)^gamma_p); 
...
(c2lmult11*wages*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc*(cc - muc)^gamma_p) - c2lmult27*labor*wages; 
(c2lmult12*wages2*(-(wages2*(tau_l2 - 1))/(chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p) - c2lmult28*labor2*wages2; 
(c2lmult11*(tau_l - 1)*(-(wages*(tau_l - 1))/(chi0_p*r_price_cc*(cc - muc)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc*(cc - muc)^gamma_p) - c2lmult27*labor*tau_l - c2lmult13*exp(-theta); 
(c2lmult12*(tau_l2 - 1)*(-(wages2*(tau_l2 - 1))/(chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2*(cc2 - muc2)^gamma_p) - c2lmult28*labor2*tau_l2 - c2lmult14*exp(-theta2); 
