...
lmss_mat(1,28) = 0; 
lmss_mat(1,29) = 0; 
lmss_mat(1,30) = -(gamma_p*((cc_ss - muc_ss)/(cc2_ss - muc2_ss))^(gamma_p - 1))/(cc2_ss - muc2_ss); 
lmss_mat(1,31) = 0; 
lmss_mat(1,32) = 0; 
lmss_vec(2) = 0; 
lmss_mat(2,1) = 0; 
...
lmss_mat(2,28) = 1; 
lmss_mat(2,29) = 0; 
lmss_mat(2,30) = (gamma_p*(cc_ss - muc_ss)*((cc_ss - muc_ss)/(cc2_ss - muc2_ss))^(gamma_p - 1))/(cc2_ss - muc2_ss)^2; 
lmss_mat(2,31) = 0; 
lmss_mat(2,32) = 0; 
lmss_vec(3) = 0; 
lmss_mat(3,1) = 0; 
...
lmss_mat(15,29) = 0; 
lmss_mat(15,30) = 0; 
lmss_mat(15,31) = -tau_l_ss*wages_ss; 
lmss_mat(15,32) = 0; 
lmss_vec(16) = 0; 
lmss_mat(16,1) = 0; 
lmss_mat(16,2) = 0; 
...
lmss_mat(16,30) = 0; 
lmss_mat(16,31) = 0; 
lmss_mat(16,32) = -tau_l2_ss*wages2_ss; 
lmss_vec(17) = 0; 
lmss_mat(17,1) = 0; 
lmss_mat(17,2) = 0; 
lmss_mat(17,3) = 0; 
...
lmss_mat(17,5) = 0; 
lmss_mat(17,6) = 0; 
lmss_mat(17,7) = -gdp_ss*((tau_p + 1)/theta_p - (sigma_ss*(theta_p + 1))/theta_p); 
lmss_mat(17,8) = 0; 
lmss_mat(17,9) = 1; 
lmss_mat(17,10) = 0; 
lmss_mat(17,11) = 0; 
...
lmss_mat(18,6) = 0; 
lmss_mat(18,7) = 0; 
lmss_mat(18,8) = -gdp2_ss*((tau_p + 1)/theta_p - (sigma2_ss*(theta_p + 1))/theta_p); 
lmss_mat(18,9) = 0; 
lmss_mat(18,10) = 0; 
lmss_mat(18,11) = 0; 
lmss_mat(18,12) = 1; 
...
lmss_mat(19,3) = 0; 
lmss_mat(19,4) = 0; 
lmss_mat(19,5) = 1/(rate1_ss + 1)^2; 
lmss_mat(19,6) = 0; 
lmss_mat(19,7) = -(dphidlp_ss*gdp_ss*(tau_p - sigma_ss + 1))/(rate1_ss + 1)^2; 
lmss_mat(19,8) = 0; 
lmss_mat(19,9) = 0; 
lmss_mat(19,10) = 0; 
lmss_mat(19,11) = 0; 
...
lmss_mat(20,4) = 0; 
lmss_mat(20,5) = 0; 
lmss_mat(20,6) = 1/(rate2_ss + 1)^2; 
lmss_mat(20,7) = 0; 
lmss_mat(20,8) = -(dphidlp2_ss*gdp2_ss*(tau_p - sigma2_ss + 1))/(rate2_ss + 1)^2; 
lmss_mat(20,9) = 0; 
lmss_mat(20,10) = 0; 
lmss_mat(20,11) = 0; 
lmss_mat(20,12) = 0; 
...
lmss_mat(21,22) = 0; 
lmss_mat(21,23) = 0; 
lmss_mat(21,24) = -(cc_ss*r_price_cc_ss*(r_price_cc_ss/r_exchg_ss)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg_ss^2*rho_cc_p); 
lmss_mat(21,25) = 0; 
lmss_mat(21,26) = 0; 
lmss_mat(21,27) = 0; 
lmss_mat(21,28) = 0; 
lmss_mat(21,29) = 1; 
lmss_mat(21,30) = r_price_cc2_ss/r_price_cc_ss; 
lmss_mat(21,31) = 0; 
lmss_mat(21,32) = 0; 
lmss_vec(22) = 0; 
lmss_mat(22,1) = 0; 
...
lmss_mat(22,25) = 0; 
lmss_mat(22,26) = 0; 
lmss_mat(22,27) = -(cc2_ss*r_price_cc2_ss*(r_price_cc2_ss/r_exchg2_ss)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2_ss^2*rho_cc_p); 
lmss_mat(22,28) = 0; 
lmss_mat(22,29) = 1/r_exchg2_ss^2; 
lmss_mat(22,30) = 0; 
lmss_mat(22,31) = 0; 
lmss_mat(22,32) = 0; 
lmss_vec(23) = 0; 
...
lmss_mat(23,3) = 0; 
lmss_mat(23,4) = 0; 
lmss_mat(23,5) = (beta_p*(cc_ss - muc_ss)^gamma_p)/(infl_ss*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p) - (beta_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p)/(infl_ss*nbeta*r_price_cc_ss^2*(cc_ss - muc_ss)^gamma_p); 
lmss_mat(23,6) = 0; 
lmss_mat(23,7) = 0; 
lmss_mat(23,8) = 0; 
lmss_mat(23,9) = 0; 
...
lmss_mat(23,13) = 0; 
lmss_mat(23,14) = 0; 
lmss_mat(23,15) = -(wages_ss*(tau_l_ss - 1)*(-(wages_ss*(tau_l_ss - 1))/(chi0_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc_ss^2*(cc_ss - muc_ss)^gamma_p); 
lmss_mat(23,16) = 0; 
lmss_mat(23,17) = 0; 
lmss_mat(23,18) = 0; 
lmss_mat(23,19) = 0; 
...
lmss_mat(23,21) = 0; 
lmss_mat(23,22) = 0; 
lmss_mat(23,23) = -(cc_ss*omega_cc_p*r_price_cc_ss^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p; 
lmss_mat(23,24) = (cc_ss*(r_price_cc_ss/r_exchg_ss)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg_ss*rho_cc_p); 
lmss_mat(23,25) = 0; 
lmss_mat(23,26) = 0; 
lmss_mat(23,27) = 0; 
lmss_mat(23,28) = 0; 
lmss_mat(23,29) = 0; 
lmss_mat(23,30) = -(r_exchg_ss*r_price_cc2_ss)/r_price_cc_ss^2; 
lmss_mat(23,31) = 0; 
lmss_mat(23,32) = 0; 
lmss_vec(24) = 0; 
lmss_mat(24,1) = 0; 
...
lmss_mat(24,4) = 0; 
lmss_mat(24,5) = 0; 
lmss_mat(24,6) = (beta_p*(cc2_ss - muc2_ss)^gamma_p)/(infl2_ss*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p) - (beta_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p)/(infl2_ss*nbeta*r_price_cc2_ss^2*(cc2_ss - muc2_ss)^gamma_p); 
lmss_mat(24,7) = 0; 
lmss_mat(24,8) = 0; 
lmss_mat(24,9) = 0; 
lmss_mat(24,10) = 0; 
...
lmss_mat(24,14) = 0; 
lmss_mat(24,15) = 0; 
lmss_mat(24,16) = -(wages2_ss*(tau_l2_ss - 1)*(-(wages2_ss*(tau_l2_ss - 1))/(chi0_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2_ss^2*(cc2_ss - muc2_ss)^gamma_p); 
lmss_mat(24,17) = 0; 
lmss_mat(24,18) = 0; 
lmss_mat(24,19) = 0; 
lmss_mat(24,20) = 0; 
...
lmss_mat(24,24) = 0; 
lmss_mat(24,25) = 0; 
lmss_mat(24,26) = -(cc2_ss*omega_cc_p*r_price_cc2_ss^((rho_cc_p + 1)/rho_cc_p - 1)*(rho_cc_p + 1))/rho_cc_p; 
lmss_mat(24,27) = (cc2_ss*(r_price_cc2_ss/r_exchg2_ss)^((rho_cc_p + 1)/rho_cc_p - 1)*(omega_cc_p - 1)*(rho_cc_p + 1))/(r_exchg2_ss*rho_cc_p); 
lmss_mat(24,28) = 0; 
lmss_mat(24,29) = 0; 
lmss_mat(24,30) = r_exchg_ss/r_price_cc_ss; 
lmss_mat(24,31) = 0; 
lmss_mat(24,32) = 0; 
lmss_vec(25) = 0; 
lmss_mat(25,1) = 0; 
...
lmss_mat(25,5) = 0; 
lmss_mat(25,6) = 0; 
lmss_mat(25,7) = (gdp_ss*(phi_ss - 1)*(theta_p + 1))/theta_p - (dphidlp_ss*gdp_ss)/(nbeta*(rate1_ss + 1)) - dphidp_ss*gdp_ss; 
lmss_mat(25,8) = 0; 
lmss_mat(25,9) = 0; 
lmss_mat(25,10) = 0; 
lmss_mat(25,11) = 0; 
...
lmss_mat(26,6) = 0; 
lmss_mat(26,7) = 0; 
lmss_mat(26,8) = (gdp2_ss*(phi2_ss - 1)*(theta_p + 1))/theta_p - (dphidlp2_ss*gdp2_ss)/(nbeta*(rate2_ss + 1)) - dphidp2_ss*gdp2_ss; 
lmss_mat(26,9) = 0; 
lmss_mat(26,10) = 0; 
lmss_mat(26,11) = 0; 
lmss_mat(26,12) = 0; 
...
lmss_mat(27,13) = 0; 
lmss_mat(27,14) = 0; 
lmss_mat(27,15) = (wages_ss*(-(wages_ss*(tau_l_ss - 1))/(chi0_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p); 
lmss_mat(27,16) = 0; 
lmss_mat(27,17) = 0; 
lmss_mat(27,18) = 0; 
lmss_mat(27,19) = 0; 
...
lmss_mat(27,29) = 0; 
lmss_mat(27,30) = 0; 
lmss_mat(27,31) = -labor_ss*wages_ss; 
lmss_mat(27,32) = 0; 
lmss_vec(28) = 0; 
lmss_mat(28,1) = 0; 
lmss_mat(28,2) = 0; 
...
lmss_mat(28,14) = 0; 
lmss_mat(28,15) = 0; 
lmss_mat(28,16) = (wages2_ss*(-(wages2_ss*(tau_l2_ss - 1))/(chi0_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p); 
lmss_mat(28,17) = 0; 
lmss_mat(28,18) = 0; 
lmss_mat(28,19) = 0; 
lmss_mat(28,20) = 0; 
...
lmss_mat(28,30) = 0; 
lmss_mat(28,31) = 0; 
lmss_mat(28,32) = -labor2_ss*wages2_ss; 
lmss_vec(29) = omega_welf1; 
lmss_mat(29,1) = 1; 
lmss_mat(29,2) = -1; 
lmss_mat(29,3) = 0; 
lmss_mat(29,4) = 0; 
...
lmss_mat(31,13) = 0; 
lmss_mat(31,14) = 0; 
lmss_mat(31,15) = ((tau_l_ss - 1)*(-(wages_ss*(tau_l_ss - 1))/(chi0_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc_ss*(cc_ss - muc_ss)^gamma_p); 
lmss_mat(31,16) = 0; 
lmss_mat(31,17) = -exp(-theta_ss); 
lmss_mat(31,18) = 0; 
lmss_mat(31,19) = 0; 
lmss_mat(31,20) = 0; 
lmss_mat(31,21) = 0; 
...
lmss_mat(31,29) = 0; 
lmss_mat(31,30) = 0; 
lmss_mat(31,31) = -labor_ss*tau_l_ss; 
lmss_mat(31,32) = 0; 
lmss_vec(32) = 0; 
lmss_mat(32,1) = 0; 
lmss_mat(32,2) = 0; 
...
lmss_mat(32,14) = 0; 
lmss_mat(32,15) = 0; 
lmss_mat(32,16) = ((tau_l2_ss - 1)*(-(wages2_ss*(tau_l2_ss - 1))/(chi0_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p))^(1/chi_p - 1))/(chi_p*chi0_p*r_price_cc2_ss*(cc2_ss - muc2_ss)^gamma_p); 
lmss_mat(32,17) = 0; 
lmss_mat(32,18) = -exp(-theta2_ss); 
lmss_mat(32,19) = 0; 
lmss_mat(32,20) = 0; 
lmss_mat(32,21) = 0; 
lmss_mat(32,22) = 0; 
...
lmss_mat(32,30) = 0; 
lmss_mat(32,31) = 0; 
lmss_mat(32,32) = -labor2_ss*tau_l2_ss; 
lmss_vec(33) = 0; 
lmss_mat(33,1) = 0; 
lmss_mat(33,2) = 0; 
lmss_mat(33,3) = 0; 
